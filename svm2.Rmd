...
<p style="text-align:justify";>
Nous avons un taux d'erreur de 1.4% et donc **98,6%** d'individus correctement classés.
</p>
...
<p style="text-align:justify";>
Plus l'AUC tend vers 1 et plus la performance du modèle augmente. On voit que notre statistique est de 0.997. Cela signifie donc que, face à deux individus, l'un faisant défaut et l'autre étant sain, dans 99.7% des cas, le test arrive à distinguer l'individu qui fait défaut de la personne saine.
</p>
