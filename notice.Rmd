...
<p style="text-align:justify";>
**Rshiny** permet de créer des démonstrateurs en ligne interactifs. Cette **interactivité** est très utile. Elle permet de visualier réellement l'implémentation d'une méthode en fonction de différents paramètres. Ici, vous aurez le choix entre plusieurs paramètres associés au SVM. Chaque **paramètre** et **hyper-paramètre** sera clairement expliqué afin de comprendre leur utilité. 
</p>
